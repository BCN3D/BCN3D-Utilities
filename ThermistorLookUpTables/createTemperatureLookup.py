...
def main(argv):
    ...
    try:
        opts, args = getopt.getopt(argv, "h", ["help", "r0=", "t0=", "beta=", "r1=", "r2=", "rseries=", "num-temps=", "max-adc="])
...
#   adcs = [1, 20, 25, 30, 35, 40, 45, 50, 60, 70, 80, 90, 100, 110, 130, 150, 190, 220,  250, 300]
    ...
    print "// ./createTemperatureLookup.py --r0=%s --t0=%s --r1=%s --r2=%s --rseries=%s --beta=%s --num-temps=%s --max-adc=%s" % (r0, t0, r1, r2, rseries, beta, num_temps, max_adc)
    print "// r0: %s" % (r0)
    print "// t0: %s" % (t0)
    print "// r1: %s" % (r1)
    print "// r2: %s" % (r2)

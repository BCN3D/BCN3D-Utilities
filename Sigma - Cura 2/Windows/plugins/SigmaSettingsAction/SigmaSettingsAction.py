...
class SigmaSettingsAction(MachineAction):
    def __init__(self, parent = None):
        super().__init__("SigmaSettingsAction", catalog.i18nc("@action", "Sigma Settings"))
        self._qml_url = "SigmaSettingsAction.qml"
    ...
    def _onContainerAdded(self, container):
        ...
        if isinstance(container, DefinitionContainer) and container.getMetaDataEntry("type") == "machine":
            if container.getProperty("machine_extruder_count", "value") > 1:
                ...
                Logger.log("d", "Not attaching SigmaSettingsAction to %s; Multi-extrusion printers are not supported", container.getId())
                return

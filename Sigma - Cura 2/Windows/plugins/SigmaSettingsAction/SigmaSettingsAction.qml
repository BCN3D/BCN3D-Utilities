...
Cura.MachineAction
{
    ...
    Item
    {
        ...
        Label
        {
            id: pageTitle
            width: parent.width
            text: catalog.i18nc("@title", "Sigma Settings")
        ...
        Label
        {
            ...
            width: parent.width
            wrapMode: Text.WordWrap
            visible: "Sigma" in Cura.MachineManager.activeMachineId
            text: catalog.i18nc("@label", "Attention! In order to get the best results with your BCN3D Sigma, please make sure the Sigma Vitamins plugin is enabled under Extensions > Post Processing > Modify G-Code.")
        }
